...
[Run this example](http://examples.hilios.com.br/jquery-countdown/examples/basic.html)
...
[Run this example](http://examples.hilios.com.br/jquery-countdown/examples/coupons.html)
...
[Run this example](http://examples.hilios.com.br/jquery-countdown/examples/groupon.html)

**Need multiple countdowns on the same page?**   
No problem at all [run this example](http://examples.hilios.com.br/jquery-countdown/examples/multiple_clocks.html) and see at work.
